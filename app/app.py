...
pg = st.navigation([zawodnicy_page, wyniki_page, trenerzy_page, zawody_page, stadiony_page, world_records_page , panstwa_page, reprezentanci_page,konkurencje_page, typy_zawodow_page,])
